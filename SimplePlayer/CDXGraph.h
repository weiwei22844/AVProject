...
private:
    ...
    IMediaPosition*     pMediaPosition;     // added by ZWW for set Rate
    IBaseFilter*        pGrabberF;
    ISampleGrabber*     m_pIGrabber;         // added by ZWW for testing 
...
public:
    ...
    // these two functions are added by ZWW for testing rate set
    bool ModifyRate( double rateAdjust );
